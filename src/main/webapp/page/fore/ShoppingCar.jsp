    ...
    $(function(){
        ...
        $("img.cartProductItemIfSelected").click(function(){
            ...
            if("selectit" == selectit){
                $(this).attr("src","../../image/fore/site/cartNotSelected.png");
                $(this).attr("selectit","false")
                $(this).parents("tr.cartProductItemTR").css("background-color","#fff");
            }
            else{
                $(this).attr("src","../../image/fore/site/cartSelected.png");
        ...
        $("img.selectAllItem").click(function(){
            var selectit = $(this).attr("selectit")
            if("selectit"==selectit){
                $("img.selectAllItem").attr("src","../../image/fore/site/cartNotSelected.png");
                ...
                $("img.selectAllItem").attr("src","../../image/fore/site/cartSelected.png");
        ...
        <table class="cartProductTable">
            ...
            <tr>
                <th class="selectAndImage">
                    <img selectit="false" class="selectAllItem" src="../../image/fore/site/cartNotSelected.png">
                    全选
                </th>
                <th>商品信息</th>
                <th>单价</th>
