...
<div class="nav">
    ...
    <div style="text-align:center; ">
        <p><font style="font-family:微软雅黑;color: white;font-size: 16px;"><%= session.getAttribute("admin")%></font></p>
    </div>
    <ul>
        <li class="nav-item">
            <a href="../../page/static_page/homeshow.jsp" target="right"><strong>网站首页</strong></a>
        </li>
        <li class="nav-item">
